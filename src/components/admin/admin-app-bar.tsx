...
import { MdAdminPanelSettings, MdMail, MdNotifications, MdMenu } from "react-icons/md";

interface AdminAppBarProps {
  onMenuClick?: () => void;
}

const AdminAppBar = ({ onMenuClick }: AdminAppBarProps) => {
  ...
  return (
    <nav className="bg-[linear-gradient(to_bottom,#111D22_0%,#111D22_40%,rgba(17,29,34,0.7)_100%)] py-4 lg:py-8 px-4 lg:px-6">
      <div className="container mx-auto flex flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
            ...
            <p className="text-primary-blue text-sm md:text-lg">Admin.</p>
          </div>
        </div>
          ...
          <div>
            ...
            >
              <div className="rounded-full bg-[#204E31] p-1 md:p-1.5 shrink-0">
                <MdAdminPanelSettings size={20} className="text-primary-blue md:size-[24px]" />
              </div>
