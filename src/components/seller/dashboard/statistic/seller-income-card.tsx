...
const SellerIncomeCard = () => {
  ...
  return (
    <div className="border-bg-blue from-primary-blue/35 to-bg-nav/70 grow space-y-4 sm:space-y-5 rounded-xl border-2 bg-linear-to-b p-5 sm:p-10">
      <div className="flex items-center gap-3">
        <div className="bg-bg-nav rounded-xl p-2 sm:p-3">
          <MdAccountBalance className="text-primary-yellow size-6 sm:size-7" />
        </div>
      ...
      <div>
        <p className="text-2xl sm:text-5xl font-bold text-white">
          <span className="text-primary-yellow mr-2 sm:mr-5">IDR</span>
      ...
      <div className="mt-6 sm:mt-10! flex flex-col sm:flex-row gap-3 sm:gap-5">
